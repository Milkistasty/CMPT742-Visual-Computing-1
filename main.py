...
def bilinear_interpolation(image, x, y):
    ...
    # Clipping again for the incremented values
...
if __name__ == '__main__':
    ...
    img_path = 'C:/Users/Alienware/Desktop/vc lab1/A1-1/images/brain.png'
    ...
    alpha = 0.5  # Controls the snake's tension
    beta = 0.5  # Controls the snake's rigidity or stiffness
    gamma = 0.5  # how much influence our previous time step has
    kappa = 0.05  # weighting for the external energy
    w_line = 0  # weighting for line energy
    w_edge = 2.5  # weighting for edge energy
    w_term = 0  # weighting for term energy
    ...
    for iter in range(num_iterations):
        ...
        xt_new = M @ (gamma * xt - kappa * fx)
        yt_new = M @ (gamma * yt - kappa * fy)
    ...
    cv2.imwrite('C:/Users/Alienware/Desktop/vc lab1/A1-1/images/brain_result_eye.png', img_temp)
